...
if ( ! function_exists( 'gucherry_blog_recommended_plugins' ) ) :
    ...
    function gucherry_blog_recommended_plugins() {
        ...
        $plugins = array(
            ...
            array(
                'name'     => esc_html__( 'Noptin : Newsletter Subscribe Forms And Widgets', 'gucherry-blog' ),
                'slug'     => 'newsletter-optin-box',
                'required' => false,
            ),
            array(
                'name'     => esc_html__( 'Contact Form by WPForms : Drag & Drop Form Builder for WordPress', 'gucherry-blog' ),
                'slug'     => 'wpforms-lite',
                'required' => false,
            ),
        );
